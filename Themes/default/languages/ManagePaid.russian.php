...
$txt['paid_email_to'] = 'Электронный адрес для сообщений';
...
$txt['paypal_additional_emails_desc'] = 'Если другой (для Business аккаунта) ';
...
PortaMx Forum использует <strong>PayPal</strong> как платежный метод по умолчанию.<br>
...
Если вы используете другие платежные шлюзы, необходимо установить URL-адрес уведомлений для каждого из способов оплаты. Для всех способов оплаты этот URL-адрес должен быть задан так:<br><br>
	...
	Для других платежных шлюзов (если они установлены) этот адрес можно задать в панели аккаунта шлюза &mdash; обычно это пункты "Return URL", "Callback URL" или "Адрес для уведомлений".<br><br><br>';
