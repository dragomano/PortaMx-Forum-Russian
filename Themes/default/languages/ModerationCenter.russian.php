...
$txt['mc_description'] = 'Это ваш «Центр модерации». Здесь вы выполняете действия по модерированию форума, которые разрешены администратором. Эта страница отражает все последние события на форуме.';
...
$txt['mc_warnings'] = 'Журнал предупреждений';
$txt['mc_notes'] = 'Примечания для модераторов';

$txt['mc_notes_delete_own'] = 'Вы можете удалять только свои записи.';
$txt['mc_cannot_connect_sm'] = 'Невозможно соединиться с portamx.com для получения последних новостей.';
...
$txt['mc_reportedp_ignore_confirm'] = 'Если выбрать "OK", то то форум будет молча игнорировать все последующие попытки жалоб на это сообщение; модераторы больше не увидят никаких жалоб на это сообщение. Хотите сделать это?';
...
$txt['mc_warning_log'] = 'Журнал предупреждений';
$txt['mc_warning_templates'] = 'Свои шаблоны';
$txt['mc_warning_log_title'] = 'Посмотреть журнал предупреждений';
