...
$txt['lang_rtl'] = false;
$modSettings['time_format'] = '%Y %B %d, %H:%M:%S';
...
$txt['pmx_installer'] = 'Установка PortaMx Forum';
...
$txt['congratulations_help'] = 'При возникновении любых проблем, связанных с работой форума, не забывайте про <a href="https://www.portamx.com" target="_blank" rel="noopener">официальный сайт поддержки</a>.';
...
$txt['good_luck'] = 'Удачи!<br>PortaMx corp.';

$txt['install_welcome'] = 'Добро пожаловать';
$txt['install_welcome_desc'] = 'Добро пожаловать в PortaMx Forum. Этот скрипт проведет вас через процесс установки %1$s. В течение нескольких следующих шагов потребуется указать некоторые данные, после чего форум будет готов к использованию.';
...
$txt['default_topic_subject'] = 'Добро пожаловать на форум PortaMx!';
$txt['default_topic_message'] = 'Добро пожаловать на форум PortaMx!<br><br>Надеемся, вам понравится использование этого форума. При возникновении каких-либо проблем, обращайтесь на [url=https://www.portamx.com]официальный сайт поддержки[/url].<br><br>Большое спасибо!<br>PortaMx corp.';
...
$txt['default_news'] = 'Форум PortaMx только что установлен!';
$txt['default_reserved_names'] = 'Admin\nWebmaster\nGuest\nroot';
$txt['default_smileyset_name'] = 'Набор от PortaMx';
$txt['default_default_smileyset_name'] = 'Набор по умолчанию';
...
$txt['default_portamx_smileyset_name'] = 'Набор от PortaMx';
$txt['default_theme_name'] = 'Стандартная тема PortaMx';
$txt['default_core_theme_name'] = 'Тема Core';
...
$txt['install_settings_info'] = 'На этом шаге требуется указать основные настройки форума. PortaMx Forum автоматически определил некоторые из них.';
...
$txt['force_ssl_label'] = 'Принудительный режим SSL на всем форуме';
$txt['force_ssl_info'] = '<strong>Убедитесь, что SSL и HTTPS поддерживаются вашим сайтом, в противном случае форум может стать недоступным</strong>';
...
$txt['db_settings_database_info'] = 'Введите название базы данных, в которую будет установлен PortaMx Forum.';
...
$txt['db_settings_database_file_info'] = 'Название файла, в котором будут храниться данные PortaMx Forum. Мы рекомендуем использовать случайно сгенерированное название и не использовать общедоступную директорию на вашем веб-сервере.';
...
$txt['user_settings_database_info'] = 'В целях безопасности укажите пароль к базе данных.';
...
$txt['ftp_path_help'] = 'Путь FTP &mdash; путь к директории форума, который вы видите подключившись к нему FTP клиентом. Обычно, начинается с &quot;<pre>www</pre>&quot;, &quot;<pre>public_html</pre>&quot; или &quot;<pre>httpdocs</pre>&quot;, но должен включать и директорию PortaMx Forum, например, &quot;/public_html/forum&quot;. Это не то же самое, что URL-адрес форума и полный путь.<br><br> Файлы, находящиеся по указанному пути, будут перезаписаны, так что, убедитесь в его корректности.';
...
$txt['ftp_login'] = 'Информация о вашем FTP-соединении';
$txt['ftp_login_info'] = 'Программе установки требуется информация об FTP-соединении. Данные сведения не сохраняются, они лишь используются для установки PortaMx Forum.';

$txt['error_php_too_low'] = 'Внимание! Для работы PortaMx Forum <strong>требуется более новая версия PHP</strong>.<br>Если вы пользуетесь услугами хостинга, обратитесь к хостеру с просьбой обновить версию PHP или смените хостинг.<br><br>Если вы уверены, что версия PHP соответствует требованиям PortaMx Forum, установку форума можно продолжить, но это НЕ рекомендуется.';
...
$txt['error_db_too_low'] = 'Версия используемого сервера баз данных очень старая и не отвечает минимальным требованиям PortaMx Forum.<br><br>Попросите своего хостера обновить или сменить её на более новую. В случае отказа, попробуйте другой хостинг.';
$txt['error_db_database'] = 'Программа установки не может получить доступ к базе данных &quot;<em>%1$s</em>&quot;.  На некоторых хостингах базу данных нужно создать через панель администрирования, прежде чем PortaMx Forum сможет использовать её. На некоторых добавляется префикс к имени базы данных, например, имя пользователя хостинга.';
...
$txt['error_db_alter_priv'] = 'Учётная запись базы аккаунта не имеет следующих прав доступа ALTER, CREATE, и/или DROP в базе данных; это важно для правильной работы PortaMx Forum.';
$txt['error_versions_do_not_match'] = 'Программа установки обнаружила другую установленную версию PortaMx Forum с указанными настройками. Если вы хотите обновить установленную версию, воспользуйтесь программой обновления (upgrade.php).<br><br>Или вы можете указать другие настройки для установки. Или сделайте бэкап и удалите содержимое базы данных, чтобы выполнить установку заново.';
$txt['error_mod_security'] = 'Программа установки обнаружила установленный модуль mod_security. Этот модуль будет блокировать передающиеся формами данные. PortaMx Forum имеет встроенный сканер безопасности, который превосходит по возможностям этот модуль и работает намного эффективней.';
$txt['error_mod_security_no_write'] = 'Программа установки обнаружила установленный модуль mod_security. Этот модуль будет блокировать передающиеся формами данные. PortaMx Forum имеет встроенный сканер безопасности, который превосходит по возможностям этот модуль и работает намного эффективней.<br><br>Также, вы можете сделать файл .htaccess доступным для записи, изменив права доступа  (chmod 777) используя фтп-клиент и обновить эту страницу.';
$txt['error_utf8_version'] = 'Текущая версия вашей базы данных не поддерживает кодировку UTF-8. Можно продолжить установку PortaMx Forum без особых проблем, но без поддержки UTF-8. Если захотите переключить форум в UTF-8 в будущем (например, после того как сервер базы данных форума будет обновлен хотя бы до версии >= %1$s), можно будет конвертировать форум в UTF-8 через панель администрирования.';
...
$txt['error_already_installed'] = 'Программа установки обнаружила, что PortaMx Forum уже установлен. Настоятельно <strong>не</strong> рекомендуется пытаться перезаписать установленный форум. Продолжение установки <strong>может привести к потере или повреждению имеющихся данных</strong>.<br><br>Если вы хотите произвести обновление, посетите сайт <a href="https://www.portamx.com">PortaMx</a> и загрузите последний пакет <em>обновления</em>.<br><br>Если вы хотите перезаписать установленный форум, стерев все данные, то рекомендуется удалить таблицы форума из существующей базы данных, удалить Settings.php и повторить попытку установки.';
$txt['error_warning_notice'] = 'Предупреждение!';
$txt['error_script_outdated'] = 'Программа установки устарела! Последняя версия PortaMx Forum: %1$s, а ваша программа установки для %2$s.<br><br>
    Рекомендуется посетить сайт <a href="https://www.portamx.com">PortaMx</a>, чтобы удостовериться, что устанавливается самая последняя версия.';
...
$txt['upgrade_upgrade_utility'] = 'Утилита обновления PortaMx Forum';
...
$txt['upgrade_ready_proceed'] = 'Благодарим вас за выбор в пользу обновления до %1$s. Все требуемые файлы на месте, можно приступать.';
$txt['upgrade_error_script_js'] = 'Программа обновления не может найти файл script.js, либо он устарел. Убедитесь, что настройки путей для вашей темы оформления указаны правильно. Используйте <a href="https://www.portamx.com" target="_blank">утилиту проверки настроек</a> с сайта PortaMx.';
...
$txt['upgrade_warning_out_of_date'] = 'Программа обновления устарела! Последняя версия PortaMx Forum: <em id="pmxVersion" style="white-space: nowrap;">??</em>, а ваша программа обновления для <em id="yourVersion" style="white-space: nowrap;">%1$s</em>.<br><br>Рекомендуется посетить сайт <a href="https://www.portamx.com">PortaMx</a>, чтобы удостовериться, что вы обновляетесь на последнюю версию.';
