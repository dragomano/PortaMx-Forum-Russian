...
$txt['search_create_index_not_ready'] = 'PortaMx Forum создает поисковые индексы сообщений. Чтобы предотвратить большую загрузку сервера, процесс создания индексирования был приостановлен. Процесс автоматически продолжится через несколько секунд. В случае полной остановки нажмите на кнопку ниже.';
...
$txt['search_engines_description'] = 'Здесь можно установить уровень слежения за активностью поисковых ботов на форуме, а также просмотреть журнал посещений.';
...
$txt['spider_mode_note'] = 'Помните, что запись в журнал каждого действия пауков происходит только при установке уровня отслеживания на "Высокий" или "Очень высокий". Детализация каждого действия пауков записывается в журнал только при установке уровня отслеживания на "Очень высокий".';
$txt['spider_mode_off'] = 'Не отслеживать';
$txt['spider_mode_standard'] = 'Стандартный (минимум записей)';
...
$txt['spider_settings_desc'] = 'В данном разделе можно изменить настройки отслеживания поисковых систем. Обратите внимание: если хотите настроить автоматическую очистку журнала, то настройки можно изменить <a href="%1$s">здесь</a>.';
...
$txt['spider_log_empty_log'] = 'Очистить журнал';
$txt['spider_log_empty_log_confirm'] = 'Хотите полностью очистить журнал?';
