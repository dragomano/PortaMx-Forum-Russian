...
$txt['no_email'] = 'Поле <strong>Электронный адрес</strong> обязательно для заполнения.';
...
$txt['email_invalid_character'] = 'Использован недопустимый символ в электронном адресе.';
...
$txt['email_in_use'] = 'Данный электронный адрес (%1$s) уже используется другим пользователем. Если думаете, что это ошибка, воспользуйтесь опцией напоминания пароля на странице входа.';
...
$txt['cant_find_user_email'] = 'Невозможно найти пользователя с указанным адресом электронной почты.';
...
$txt['login_cookie_error'] = 'Не удалось войти на форум. Проверьте настройки куки в браузере.';
...
$txt['invalid_email'] = 'Неправильный адрес или диапазон адресов.<br>Пример правильного электронного адреса: evil.user@badsite.com.<br>Пример правильного диапазона адресов: *@*.badsite.com';
...
$txt['post_already_deleted'] = 'Тема или сообщение уже перенесены в корзину. Хотите удалить окончательно?<br><a href="%1$s">Да, хочу</a>';
...
$txt['email_missing_data'] = 'Вы должны ввести тему и текст сообщения.';
...
$txt['pm_too_many_per_hour'] = 'Вы исчерпали лимит отправки личных сообщений в %1$d за час.';

$txt['register_only_once'] = 'Нельзя регистрировать сразу несколько пользователей за раз.';
$txt['admin_setting_coppa_require_contact'] = 'Необходимо указать свои контактные данные или номер факса для контакта с вашими родителями/опекунами (если требуется их одобрение).';
...
// recapcha messages
$txt['error_recapcha_post_preview'] = 'Пожалуйста, завершите проверку reCAPTCHA, прежде чем отправить это сообщение.';
$txt['error_recapcha_post'] = 'Вы не завершили проверку reCAPTCHA.';
...
$txt['smiley_set_path_already_used'] = 'URL-адрес набора уже используется другим набором смайлов.';
...
$txt['packageget_unable'] = 'Не удалось соединиться с сервером. Попробуйте использовать <a href="%1$s" target="_blank" rel="noopener" class="new_win">этот URL-адрес</a>.';
$txt['not_on_simplemachines'] = 'Пакеты модификаций могут быть загружены только с сервера portamx.com.';
...
$txt['package_get_error_not_found'] = 'Пакет, который вы пытаетесь установить, не удалось разместить. Попробуйте вручную загрузить пакет в директорию Packages.';
...
$txt['loadavg_userstats_disabled'] = 'Повторите попытку позже. Статистика этого пользователя в настоящее время недоступна из-за высокой нагрузки на сервер.';
...
$txt['custom_option_regex_error'] = 'Введённое регулярное выражение не является допустимым';
...
$txt['error_custom_field_invalid_email'] = 'Поле &quot;%1$s&quot; должно содержать действующий электронный адрес.';
...
$txt['email_no_template'] = 'Невозможно найти шаблон для адреса электронной почты &quot;%1$s&quot;.';
