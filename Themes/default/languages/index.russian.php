...
$txt['unread_topics_visit_none'] = 'Нет непрочитанных тем с момента вашего последнего посещения. <a href="' . $scripturl . '?action=unread;all"><strong>Просмотреть все непрочитанные темы</strong></a>.';
