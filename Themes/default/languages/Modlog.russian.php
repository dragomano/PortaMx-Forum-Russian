...
$txt['modlog_ac_clearlog_moderate'] = 'Очищен журнал модерации';
$txt['modlog_ac_clearlog_admin'] = 'Очищен журнал администрирования';
$txt['modlog_enter_comment'] = 'Ввести комментарий';
$txt['modlog_moderation_log'] = 'Журнал модерации';
...
$txt['modlog_remove_selected_confirm'] = 'Хотите удалить выбранные записи?';
$txt['modlog_remove_all_confirm'] = 'Хотите полностью очистить журнал?';
$txt['modlog_go'] = 'Поиск';
