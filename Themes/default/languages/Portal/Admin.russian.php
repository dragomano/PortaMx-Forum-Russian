...
$txt['pmx_admin_main_welcome'] = 'Вы находитесь в центре управления порталом.
	...
	Дополнительную информацию по возникающим вопросам можно получить, кликнув на значке %s рядом с соответствующими функциями.';
$txt['pmx_admin_main_custom'] = $txt['pmx_admin_main_welcome'];
...
$txt['pmx_articles_desc'] = 'В этом разделе доступны такие операции, как создание, изменение, клонирование или удаление статей.
