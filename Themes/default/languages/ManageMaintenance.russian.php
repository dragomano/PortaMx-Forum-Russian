...
$txt['repair_operation_missing_notify_members'] = 'Журнал сообщений ссылается на несуществующего пользователя';
...
$txt['filter_only_message'] = 'Показать ошибки только с тем же сообщением';
$txt['session'] = 'Сессия';
...
$txt['errortype_database_desc'] = 'Ошибки, вызванные некорректными запросами. Должны быть рассмотрены и сообщены команде PortaMx Forum.';
...
$txt['errortype_ban_desc'] = 'Журнал попыток доступа к форуму забаненных пользователей.';
...
$txt['maintain_logs_info'] = 'Очищает ненужные записи в журналах, которые больше не нужны.';
...
$txt['maintain_cache_info'] = 'Используется для очистки кэша, когда требуется чтобы форум «забыл» старые данные.
	Если включена опция «Отображать состояние кэша для каждой страницы», любой администратор может очистить кэш, нажав на ссылку <strong>Кэш:</strong> в подвале форума.';
...
$txt['maintain_old_drafts_confirm'] = 'Хотите удалить старые черновики?\\nЭто действие нельзя отменить!';
...
$txt['maintain_members_confirm'] = 'Хотите удалить учётную запись этого пользователя?\\nЭто действие нельзя будет отменить!';
...
$txt['reattribute_email'] = 'Электронным адресом';
