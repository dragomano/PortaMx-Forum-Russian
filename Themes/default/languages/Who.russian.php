...
$txt['who_admin'] = 'Просматривает админку';
...
$txt['whoallow_admin'] = 'Находится в <a href="' . $scripturl . '?action=admin">админке</a>.';
...
$txt['credits_intro'] = 'PortaMx выражает благодарность всем, кто помог сделать наш движок таким, какой он сейчас; влияя на нас и направляя наш проект через все преграды. Это было бы невозможно без вас. Спасибо всем нашим пользователям и, особенно, группе Charter Members — за установку и использование нашего программного обеспечения, за обратную связь с нами, сообщения об ошибках, за ваше мнение о проекте.';
$txt['credits_team'] = 'Команда проекта';
$txt['credits_groups_pm'] = 'Менеджеры проекта';
$txt['credits_groups_lang'] = 'Переводчики';
